...
import { buildOAuthUrl, signin } from "@/lib/auth";
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  disabled={isLoading}
                  className="appearance-none relative block w-full pl-10 pr-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm transition-colors disabled:bg-gray-100 disabled:cursor-not-allowed"
          ...
          <div className="space-y-3">
            ...
            >
              {isLoading ? (
                ...
                <>
                  <i className="fas fa-sign-in-alt text-white font-bold mr-2"></i>
                  Sign In
                </>
              )}
            </button>
            ...
            <button
              ...
              className="w-full flex justify-center items-center py-3 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 hover:shadow-md cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
